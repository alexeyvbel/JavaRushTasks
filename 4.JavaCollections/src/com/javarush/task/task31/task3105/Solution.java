...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        try (ZipInputStream zipReader = new ZipInputStream(new FileInputStream(pathZip))) {
            ZipEntry entry;
        ...
        try (ZipOutputStream zipWriter = new ZipOutputStream(new FileOutputStream(pathZip))) {
